# Contributing to NTDSWolf

Thanks for your interest in improving NTDSWolf. This document covers how to get set up and what's expected in a pull request.
...
Use the [bug report template](https://github.com/StrongWind1/NTDSWolf/issues/new?template=bug_report.md). Include the exact command, full output, and your environment details.
