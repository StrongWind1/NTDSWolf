...
> **Historical design document (2025-05-22).** This captures the original v0.1.0 design. The implementation has since evolved -- the decoder registry and worker pool are live, Kerberos/WDigest/cleartext extract via dissect, and output is cross-validated against impacket. For the current state and remaining work, see [`ROADMAP.md`](../ROADMAP.md).
